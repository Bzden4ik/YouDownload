...
const api = {
  ...
  fetchTwitchDelta: (channelName: string, type: 'vods' | 'clips') => ipcRenderer.invoke('fetch-twitch-delta', channelName, type),
  ...
  getTwitchPinnedChannels: () => ipcRenderer.invoke('get-twitch-pinned-channels'),

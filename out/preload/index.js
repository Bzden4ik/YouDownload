...
const api = {
  ...
  fetchTwitchChannel: (channelName, type, refresh) => electron.ipcRenderer.invoke("fetch-twitch-channel", channelName, type, refresh),
  fetchTwitchDelta: (channelName, type) => electron.ipcRenderer.invoke("fetch-twitch-delta", channelName, type),
  getTwitchCacheMeta: (channelName) => electron.ipcRenderer.invoke("get-twitch-cache-meta", channelName),
  setTwitchChannelPin: (channelName, pinned) => electron.ipcRenderer.invoke("set-twitch-channel-pin", channelName, pinned),
  getTwitchPinnedChannels: () => electron.ipcRenderer.invoke("get-twitch-pinned-channels"),
  debugListFormats: (url) => electron.ipcRenderer.invoke("debug-list-formats", url),
  getCookiesStale: () => electron.ipcRenderer.invoke("get-cookies-stale"),
  resetCookiesStale: () => electron.ipcRenderer.invoke("reset-cookies-stale"),
